...
Module definitions for mod. Centralizes project configuration.
...
`src/config/types.rs`
Implements types functionality. Centralizes project configuration.
...
`src/bin/slopchop.rs`
Implements slopchop functionality. Defines command-line interface.
...
`src/analysis/ast.rs`
Implements ast functionality. Supports application functionality.
...
Implements file analysis. Supports application functionality.
→ Exports: analyze_file, has_ignore_directive, is_ignored

`src/analysis/logic.rs`
Implements logic functionality. Supports application functionality.
→ Exports: run_scan
...
Implements rust functionality. Supports application functionality.
...
Implements queries functionality. Supports application functionality.
...
Implements metrics functionality. Supports application functionality.
...
`src/lang.rs`
Implements lang functionality. Supports application functionality.
...
Implements validator tests. Verifies correctness.
