...
pub enum Commands {
    ...
    Audit {
        ...
        #[arg(long)] no_dead: bool,
        #[arg(long)] no_dups: bool,
        #[arg(long)] no_patterns: bool,
        #[arg(long, default_value = "5")] min_lines: usize,
        #[arg(long, default_value = "50")] max: usize,
    ...
    Signatures { #[arg(long, short)] copy: bool, #[arg(long, short)] stdout: bool },
}
