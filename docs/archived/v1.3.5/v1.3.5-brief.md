...
## 4. Success Criteria
*   [x] `slopchop check --json | jq .total_violations` works.
*   [x] `slopchop sabotage src/main.rs` modifies the staged file but leaves real file alone.
*   [x] `slopchop pack --spec` produces a readable architecture doc.